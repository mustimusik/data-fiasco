...
def insert_to_registered_user(registered_user_worksheet, registered_user, data_member_terbaru, buyer, user):
  ...
  new_registered_user = buyer.merge(user, on='email_user', how='left').merge(data_member_terbaru_filtered, left_on='email_user', right_on='user_email', how='left').copy()[['id', 'email_user', 'nomor_user_x', 'created_at', 'expired_at']]
